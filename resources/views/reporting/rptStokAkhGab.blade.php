...
<div class="card">
  ...
  <div class="card-body" style="height:500px;overflow:auto;">
    ...
    @endphp
    <h4 style="text-align:center;">STOK AKHIR GABUNGAN</h4>
        ...
        @foreach ($getSelDt as $jsnx)
          ...
          @if ($loop->index > 0 && $current_tr != $jsnx['kodelok'])
            ...
            <tr>
              ...
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'lowQty') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'lowVol') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'middleQty') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'middleVol') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'highQty') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'highVol') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'totalQty') }}</td>
              <td style="background-color: #eeeee4;border: 1px solid #000000;">{{ App\Http\Controllers\UserController::rptStokAkhGab_subTot($current_tr,session('tgl_laporan'),'totalVol') }}</td>
            </tr>
            <tr>
              <td colspan="10"></td>
            </tr>
