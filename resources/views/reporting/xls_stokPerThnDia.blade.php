<div class="card">
  ...
  <div class="card-body">
    ...
    <div>
      <table>
        <tr>
          <td colspan="9" align="center" style="font-size:20px;"><b>PT. BTS</b></td>
        </tr>
        <tr>
          <td colspan="9" align="center"><h5>Stock Log Tgl : {{ $tgl_laporan_d }} sampai {{ $tgl_laporan_s }}</h5></td>
        </tr>
        <tr>
          <td colspan="9" align="center"><h5>Tahun Produksi : {{ $thn_produksi }}</h5></td>
        </tr>
      </table>
    </div> 
